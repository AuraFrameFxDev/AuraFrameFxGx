...
sealed class AIImageState {
     ...
     */
    data class Success(val _image: Any?) : AIImageState() // TODO: Define proper type for image. Param _image reported as unused.

    /**
     * Represents an error during image generation.
     * @param _message The error message. Parameter reported as unused.
     */
    data class Error(val _message: String) : AIImageState() // TODO: Param _message reported as unused.
}
