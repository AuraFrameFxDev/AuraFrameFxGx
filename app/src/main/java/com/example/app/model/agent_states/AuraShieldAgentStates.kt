...
data class SecurityContextState( // Renamed to avoid clash with android.content.Context or other SecurityContext classes
...
data class ActiveThreat( // Singular, as it will be in a list
    val threatId: String,
